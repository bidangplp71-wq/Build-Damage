...
export const DEFAULT_GOOGLE_SHEET_CONFIG: GoogleSheetConfig = {
  ...
  spreadsheetProfiles: [
    ...
    },
    {
      ...
      spreadsheetUrl: '',
      webhookUrl: 'https://script.google.com/macros/s/AKfycbyAbubspPnACJi6KTODHJbVeAIppC6e72c8nAo__g8uc67GmY-wc1lOZWZkbLtieds/exec',
      description: 'Spreadsheet survei lanjutan dan pemulihan pascabencana gedung terdampak',
      capacityStatus: 'normal',
      estimatedRowCount: 0,
      maxCapacityRows: 300,
    ...
    },
    {
      ...
      spreadsheetUrl: '',
      webhookUrl: 'https://script.google.com/macros/s/AKfycbyAbubspPnACJi6KTODHJbVeAIppC6e72c8nAo__g8uc67GmY-wc1lOZWZkbLtieds/exec',
      description: 'Worksheet hasil audit dan validasi tim ahli verifikator TABG',
      capacityStatus: 'normal',
      estimatedRowCount: 0,
      maxCapacityRows: 300,
    ...
    },
    {
      ...
      spreadsheetUrl: '',
      webhookUrl: 'https://script.google.com/macros/s/AKfycbyAbubspPnACJi6KTODHJbVeAIppC6e72c8nAo__g8uc67GmY-wc1lOZWZkbLtieds/exec',
      description: 'Worksheet konsolidasi lintas kecamatan dan pemodelan anggaran biaya',
      capacityStatus: 'normal',
      estimatedRowCount: 0,
      maxCapacityRows: 300,
      createdAt: '2026-09-15T00:00:00Z',
    ...
    },
    {
      ...
      spreadsheetUrl: '',
      webhookUrl: 'https://script.google.com/macros/s/AKfycbyAbubspPnACJi6KTODHJbVeAIppC6e72c8nAo__g8uc67GmY-wc1lOZWZkbLtieds/exec',
      description: 'Penyimpanan arsip permanen dan dokumentasi riwayat bencana PUPR',
      capacityStatus: 'normal',
      estimatedRowCount: 0,
      maxCapacityRows: 300,
      createdAt: '2026-09-15T00:00:00Z',
